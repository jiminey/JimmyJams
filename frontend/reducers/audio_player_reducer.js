...
const intialState = {playState: false, songUrl: null, songId: null, songList: []}
...
const audioPlayersReducer = (oldState = intialState, action) => {
    ...
    switch (action.type) {
        case PLAYSONG:
            return Object.assign(newState, {songId: action.songId}, {songUrl: action.song_fileUrl}, {playState: true})
        case PAUSESONG:
