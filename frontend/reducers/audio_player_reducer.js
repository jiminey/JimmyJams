...
const intialState = {playState: false, songUrl: null, songId: null, songList: [], currentSong: null}
...
const audioPlayersReducer = (oldState = intialState, action) => {
    ...
    switch (action.type) {
        case PLAYSONG:
            return Object.assign(newState, { currentSong: action.currentSong, songId: action.songId, songUrl: action.songUrl, playState: true } )
        case PAUSESONG:
