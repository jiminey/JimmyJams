...
class CreateSong extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props
      .createSong(formData)
      .then(res => this.props.history.push(`/library`));
  }
  ...
  handleAlbumCover(e) {
    ...
    alert(
      "Selected file name: " +
        ...
        " " +
        e.currentTarget.files.item(0).type
    );
  }
    ...
    if (this.state.loading === true) {
      ...
      return (
        <div>
          <div>
            {" "}
            <input className="form-upload-btn" type="submit" value="Upload" />
          </div>
        </div>
      );
    }
      ...
      <div>
        ...
        <div className="upload-main">
          <div className="upload-size">
            ...
            <form onSubmit={this.handleSubmit}>
              <div className="form-content">
                <h1 className="fh1">
                  Choose and upload your tracks and albums here
                </h1>
                <br />
                <label>
                  Title:
            ...
            <p className="fine-print-upload">
              ...
              <span className="blue-hyperlink-upload">
                {" "}
          ...
          <p className="fine-print-under2">
            ...
            <span> Imprints </span>⁃<span> Charts </span>⁃
