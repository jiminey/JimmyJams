...
class UserSongItem extends React.Component {
  ...
  play(e) {
    if (
      ...
      this.props.currentSong.title === this.props.song.title &&
        ...
        <div className="main-user">
          <div className="other-user-song-content">
            ...
            <div className="user-song-words">
              <div>
                <div className="user-artist">{this.props.song.artist}</div>

                <div className="user-title">{this.props.song.title}</div>
              </div>
